...
import { CampaignScreen } from "../pages/campaigns/CampaignScreen";
import { PaymentContainer } from "../features/payment/containers/PaymentContainer";
import { ResultScreen } from "../pages/campaigns/ResultScreen";
import { EmailConfirmationScreen } from "../pages/campaigns/EmailConfirmationScreen";
import { AdminDashboard } from "../pages/admin/AdminDashboard";
import { KioskManagement } from "../pages/admin/KioskManagement";
import { DonationManagement } from "../pages/admin/DonationManagement";
import { UserManagement } from "../pages/admin/UserManagement";
import CampaignManagement from "../pages/admin/CampaignManagement";
import { doc, getDoc, db } from "../shared/lib/firebase";
import { HomePage } from "../pages/home/HomePage";
import { AboutPage } from "../pages/home/AboutPage";
import { ContactPage } from "../pages/home/ContactPage";
import { DocumentationPage } from "../pages/home/DocumentationPage";
import { TermsPage } from "../pages/home/TermsPage";
import { Toast, ToastHost } from "../shared/ui/Toast";
    ...
    <div className="min-h-screen bg-background">
      ...
      {currentScreen === "campaigns" && (
        <CampaignListContainer
          onSelectCampaign={(campaign: Campaign) => handleCampaignSelect(campaign, false)}
          onViewDetails={(campaign: Campaign) => handleCampaignSelect(campaign, true)}
