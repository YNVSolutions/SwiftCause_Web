...
export function LoginScreen({ onLogin, onGoBackToHome }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-green-50 via-emerald-50 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>

      <div className="flex min-h-screen relative z-10">
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 flex-col justify-center p-6 xl:p-12">
          <div className="max-w-lg mx-auto w-full">
            <Button onClick={onGoBackToHome} variant="ghost" size="icon" className="absolute top-4 left-4 text-green-700 hover:text-green-900">
            ...
            <button onClick={onGoBackToHome} className="flex items-center space-x-3 mb-2 text-left hover:opacity-80 transition-all duration-300 hover:scale-105 group">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900 group-hover:text-green-700 transition-colors">Swift Cause</h1>
            ...
            <h2 className="text-3xl xl:text-4xl font-bold text-gray-900 mb-4 leading-tight animate-fade-in">
              Powering <span className="text-transparent bg-clip-text bg-linear-to-r from-green-600 via-emerald-600 to-green-700 animate-gradient">global</span> generosity
            </h2>
            ...
            <div className="grid grid-cols-2 gap-4 mb-12 animate-fade-in-delay-2">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-green-100 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer group">
                <div className="flex items-center justify-between mb-2">
                  <div className="h-6 w-6 text-green-600 transform group-hover:scale-110 transition-transform">
                    <DollarSign className="h-6 w-6" />
                  </div>
                  <Badge variant="secondary" className="text-xs bg-green-100 text-green-700 border-green-200 animate-pulse">Live</Badge>
                </div>
                <div className="text-xl xl:text-2xl font-semibold text-gray-900 group-hover:text-green-700 transition-colors">
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-green-100 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer group">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge variant="secondary" className="text-xs bg-green-100 text-green-700 border-green-200">Active</Badge>
                </div>
                <div className="text-xl xl:text-2xl font-semibold text-gray-900 group-hover:text-green-700 transition-colors">
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-green-100 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer group">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge variant="secondary" className="text-xs bg-green-100 text-green-700 border-green-200">Global</Badge>
                </div>
                <div className="text-xl xl:text-2xl font-semibold text-gray-900 group-hover:text-green-700 transition-colors">
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-green-100 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer group">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge variant="secondary" className="text-xs bg-green-100 text-green-700 border-green-200">Online</Badge>
                </div>
                <div className="text-xl xl:text-2xl font-semibold text-gray-900 group-hover:text-green-700 transition-colors">
                  {stats.activeKiosks}
                </div>
            ...
            <div className="space-y-4 animate-fade-in-delay-3">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white/70 backdrop-blur-md rounded-xl p-4 border border-white/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-102">
                  <div className="w-12 h-1 bg-linear-to-r from-green-500 via-emerald-500 to-green-600 rounded-full my-3"></div>
        ...
        <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-4 sm:p-6 lg:p-6 xl:p-8">
          <div className="w-full max-w-md animate-slide-in-right">
            <div className="lg:hidden text-center mb-6">
              <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-green-600 to-emerald-600 shadow-lg animate-bounce-slow">
            ...
            <Card className="bg-white/95 backdrop-blur-md border-green-100/70 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02]">
              <CardHeader className="text-center space-y-1 pt-6 pb-4">
                <CardTitle className="text-lg sm:text-xl lg:text-2xl bg-linear-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Platform Access</CardTitle>
              ...
              <CardContent className="space-y-4 pt-2 pb-6 px-4 sm:px-6">
                <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'kiosk' | 'admin')}>
                  <TabsList className="grid w-full grid-cols-2 h-11 bg-green-50/80 p-1">
                    <TabsTrigger value="admin" className="flex items-center space-x-2 text-sm data-[state=active]:bg-green-600 data-[state=active]:text-white data-[state=active]:shadow-sm">
                      <UserCog className="w-4 h-4" />
                      <span>User</span>
                    </TabsTrigger>
                    <TabsTrigger value="kiosk" className="flex items-center space-x-2 text-sm data-[state=active]:bg-green-600 data-[state=active]:text-white data-[state=active]:shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {features.slice(0, 4).map((feature, index) => (
                        <div key={index} className="flex items-center space-x-2 p-2 bg-gray-50 rounded-lg">
                          <feature.icon className="w-3.5 h-3.5 text-green-600 shrink-0" />
                ...
                <div className="pt-3 border-t text-center space-y-1.5">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center sm:space-x-4 space-y-1 sm:space-y-0 text-xs sm:text-sm">
                    <a href="mailto:swiftcauseweb@gmail.com" className="text-green-700 hover:text-green-800 font-medium">
