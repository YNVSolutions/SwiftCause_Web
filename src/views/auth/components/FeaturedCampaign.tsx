...
export function FeaturedCampaign() {
  ...
  // Auto-rotate campaigns every 6 seconds
  useEffect(() => {
    ...
    <div className="w-full max-w-lg mx-auto mb-8 animate-fade-in-delay-2">
      ...
      <div className="relative">
        ...
        <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-green-100/50 overflow-hidden">
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-br ${campaign.gradient} transition-all duration-1000`}
          />
          ...
          <div className="relative p-8">
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center space-x-2">
                <div className={`${campaign.accentColor} text-white p-3 rounded-xl shadow-lg`}>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="relative">
                ...
                <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                  ...
                  <div
                    className={`h-full ${campaign.accentColor} rounded-full transition-all duration-1000 ease-out relative overflow-hidden`}
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200/50">
              ...
              <div className={`h-1 w-16 ${campaign.accentColor} rounded-full`} />
            </div>
          </div>
