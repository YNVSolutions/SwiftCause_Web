                      ...
                      >
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            ...
                            <div className="mt-1 text-xs text-gray-500 truncate">{donation.donorId}</div>
                        ...
                        <div className="mt-3 flex items-center justify-between gap-2">
                          <div className="min-w-0">
                            ...
                            {donation.isGiftAid && (
                              <span className="mt-1 inline-flex items-center rounded-full bg-purple-50 px-2 py-0.5 text-[11px] font-medium text-purple-700 ring-1 ring-purple-600/20">
                                Gift Aid
                              </span>
                            )}
                          </div>
                        ...
                        <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-gray-600">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="truncate">{donation.timestamp}</span>
                          </div>
