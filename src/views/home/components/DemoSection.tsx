...
import { PenTool, Tv, Activity, X, Heart, Plus, Layout, Menu } from 'lucide-react';
...
export function DemoSection() {
  ...
  return (
    <section
      id="demo"
      className="py-16 sm:py-20 md:py-24 bg-[#F3F1EA] px-4 sm:px-6 overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/3 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              {(Object.keys(demoContent) as Array<'campaign' | 'kiosk' | 'dashboard'>).map(
                (tab) => (
                  <button
                    key={tab}
                  ...
                  >
                    <div
                      className={`p-2 sm:p-3 rounded-xl ${activeTab === tab ? 'bg-[#064e3b] text-white' : 'bg-slate-200'}`}
                    >
                      {demoContent[tab].icon}
                    </div>
                    <div className="flex-1 min-w-0">
                      <h4
                        className={`font-bold text-sm sm:text-base ${activeTab === tab ? 'text-[#064e3b]' : 'text-slate-600'}`}
                      >
                        {demoContent[tab].title}
                      </h4>
                      <p className="text-xs sm:text-sm opacity-80 line-clamp-1">
                        {demoContent[tab].description}
                      </p>
                    </div>
                  </button>
                ),
                ...
                <div className="w-full max-w-2xl flex items-center justify-center animate-fade-in">
                  <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full overflow-hidden border border-slate-200">
                    ...
                    <div className="bg-slate-50 border-b border-slate-200 px-3 sm:px-4 py-2 sm:py-2.5 flex items-center justify-between">
                      <div>
                        <div className="text-[8px] sm:text-[9px] text-slate-500 uppercase tracking-wider mb-0.5">
                          Edit • Campaign
                        </div>
                        <h3 className="text-xs sm:text-sm font-bold text-[#064e3b]">
                          General Information
                        </h3>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row">
                      ...
                      <div className="hidden sm:block w-32 md:w-36 bg-slate-50 border-r border-slate-200 p-2 sm:p-2.5">
                        <div className="mb-2">
                          <div className="text-[8px] sm:text-[9px] font-bold text-slate-500 mb-1">
                            Campaign
                          </div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          ...
                          <div>
                            <div className="flex items-center gap-2 mb-2 sm:mb-3">
                              ...
                              <h4 className="text-[10px] sm:text-[11px] font-bold text-slate-700">
                                Available Campaigns
                              </h4>
                          ...
                          <div className="pt-3 sm:pt-4 border-t border-slate-200">
                            <h4 className="text-[10px] sm:text-[11px] font-bold text-slate-700 mb-2 sm:mb-3">
                              Campaign View
                            </h4>

                            <div className="mb-2 sm:mb-3">
                              <div className="text-[9px] sm:text-[10px] font-bold text-slate-600 mb-2">
                                DISPLAY LAYOUT
                              </div>
                              <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                                ...
                                <div className="border border-slate-200 bg-white rounded-lg p-2 sm:p-3 flex flex-col items-center gap-1 sm:gap-2 cursor-pointer hover:border-slate-300">
                                  ...
                                  <span className="text-[8px] sm:text-[10px] font-semibold text-slate-500">
                                    LIST
                                  </span>
                                </div>
                                <div className="border border-slate-200 bg-white rounded-lg p-2 sm:p-3 flex flex-col items-center gap-1 sm:gap-2 cursor-pointer hover:border-slate-300">
                  ...
                  <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full overflow-hidden border border-slate-200">
                    ...
                    <div className="flex">
                      ...
                      <div className="hidden sm:block w-24 md:w-32 bg-[#064e3b] p-2 sm:p-3 flex flex-col">
                        <div className="mb-3 sm:mb-4">
                          <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
                            ...
                            />
                            <div className="text-white text-[8px] sm:text-[10px] font-bold">
                              SwiftCause
                            </div>
                          </div>
                      ...
                      <div className="flex-1 bg-[#F7F6F2] p-2 sm:p-3 overflow-hidden max-h-[300px] sm:max-h-[400px]">
                        <div className="mb-2">
                          <h3 className="text-[10px] sm:text-xs font-bold text-[#064e3b]">
                            Dashboard
                          </h3>
                          <p className="text-[6px] sm:text-[7px] text-slate-500">
                            Real-time fundraising activity
                          </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-1.5 mb-2">
                          <div className="bg-white rounded-lg p-1.5 border border-slate-100">
                            <div className="text-[6px] sm:text-[7px] text-slate-500 mb-0.5">
                              RAISED
                            </div>
                            <div className="text-[10px] sm:text-[11px] font-bold text-[#064e3b]">
                              £145
                            </div>
                          </div>
                          <div className="bg-white rounded-lg p-1.5 border border-slate-100">
