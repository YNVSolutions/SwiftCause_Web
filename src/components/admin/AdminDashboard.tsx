...
export function AdminDashboard({ onNavigate, onLogout, userSession, hasPermission }: AdminDashboardProps) {
  ...
  // Mock dashboard data (can be replaced with live data fetching as well)
  ...
  const recentActivities = [
    ...
    { id: 3, type: 'kiosk', message: 'Kiosk KIOSK-LA-003 came online', timestamp: '32 minutes ago', kioskId: 'KIOSK-LA-003' },
    { id: 4, type: 'donation', message: 'New donation of $500 to Emergency Disaster Relief', timestamp: '1 hour ago', kioskId: 'KIOSK-CHI-002' }
  ];
  ...
  const alerts = [
    ...
    { id: 3, type: 'success', message: 'Campaign "Clean Water for All" is trending above average', priority: 'low' }
  ];
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center text-sm text-green-600 mt-1"><ArrowUp className="w-4 h-4 mr-1" />+{dashboardData.monthlyGrowth}% this month</div>
                </div>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={donationTrends}>
                  ...
                  <YAxis />
                  <Tooltip formatter={(value, name) => [name === 'amount' ? formatCurrency(value as number) : value, name === 'amount' ? 'Amount' : 'Donations']} />
