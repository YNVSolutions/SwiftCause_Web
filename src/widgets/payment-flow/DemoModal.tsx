  ...
  const demoSteps = [
    {
      ...
      description:
        'Users browse active campaigns with rich details and real-time progress tracking',
      features: [
        ...
        <DialogContent className="!max-w-[95vw] !w-[95vw] h-[95vh] flex flex-col p-0 sm:!max-w-[95vw] sm:!w-[95vw] overflow-hidden">
          ...
          <div className="p-4 sm:p-6 pb-3 sm:pb-4 border-b bg-gradient-to-r from-green-50 to-emerald-50 backdrop-blur-sm relative overflow-hidden flex-shrink-0">
            ...
            <div className="absolute inset-0 opacity-30">
              ...
              <div
                className="absolute bottom-0 left-0 w-64 h-64 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 bg-green-400 rounded-full animate-ping opacity-50"
                style={{ animationDuration: '3s' }}
              ></div>
              <div
                className="absolute top-1/2 right-1/3 w-1 h-1 bg-emerald-400 rounded-full animate-ping opacity-50"
                style={{ animationDuration: '4s', animationDelay: '1s' }}
              ></div>
              <div
                className="absolute bottom-1/3 left-1/2 w-1 h-1 bg-green-300 rounded-full animate-ping opacity-50"
            ...
            <DialogHeader className="relative z-10">
              <DialogTitle className="flex items-center space-x-2 sm:space-x-3 text-xl sm:text-2xl">
                ...
                <div>
                  ...
                  <Badge className="ml-2 sm:ml-3 bg-green-100 text-green-800 border-green-200 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1 animate-pulse">
                    Interactive
                  </Badge>
                </div>
              </DialogTitle>
              <DialogDescription className="text-sm sm:text-base mt-2 text-gray-600">
                Experience the complete donation platform workflow from donor discovery to payment
                processing
              </DialogDescription>
            </DialogHeader>
          </div>
              ...
              <div className="flex items-center justify-between p-4 sm:p-6 bg-white/80 backdrop-blur-md border border-gray-200/50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.01] relative overflow-hidden group flex-shrink-0">
                ...
                <div className="flex items-center space-x-3 sm:space-x-4 relative z-10">
                  ...
                  >
                    ...
                    {isPlaying ? (
                      <Pause className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 relative z-10" />
                    ) : (
                      <Play className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 relative z-10" />
                    )}
                  ...
                  <Button
                    ...
                    onClick={resetDemo}
                    size="lg"
                    className="h-10 sm:h-12 px-4 sm:px-6 text-sm sm:text-base backdrop-blur-sm transition-all duration-200 hover:scale-105 hover:border-green-300 hover:bg-green-50/50"
                  >
                    ...
                    {demoSteps.map((step, index) => (
                      <button
                        ...
                        className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full transition-all duration-300 relative ${
                          index === currentStep
                            ? 'bg-green-600 scale-125 shadow-lg shadow-green-300 animate-pulse'
                            : index < currentStep
                  ...
                  <div className="relative flex-1 min-h-0">
                                    ...
                                    <div className="flex-1 space-y-2.5">
                                      <div>
                                        <h4 className="text-lg font-semibold text-gray-900">
                                          {currentStepData.mockData.campaign as string}
                                        </h4>
                                        <Badge variant="outline" className="text-xs mt-1.5">
                                          {currentStepData.mockData.category as string}
                                        </Badge>
                                      </div>
                                      ...
                                      <div className="space-y-2">
                                        <div className="flex items-center justify-between">
                                          <span className="text-sm text-gray-600">
                                            {formatCurrency(
                                              currentStepData.mockData.raised as number,
                                            )}{' '}
                                            raised
                                          </span>
                                        ...
                                        <Progress
                                          value={currentStepData.mockData.progress as number}
                                          className="h-2"
                                        />
                                        <div className="flex items-center justify-between text-xs text-gray-500">
                                          <span className="flex items-center space-x-1.5">
                                            ...
                                            <span>
                                              {currentStepData.mockData.donors as number} donors
                                            </span>
                                          </span>
                                          <span>
                                            Goal:{' '}
                                            {formatCurrencyFromMajor(
                                              currentStepData.mockData.goal as number,
                                            )}
                                          </span>
                                        </div>
                                      </div>
                          ...
                          {currentStep === 1 && (
                            <div className="h-full space-y-4 animate-fade-in">
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                {(currentStepData.mockData.amounts as number[]).map(
                                  (amount, idx) => (
                                    <Button
                                      key={idx}
                                      variant={
                              ...
                              <div className="space-y-3">
                                <div className="flex items-center space-x-3 p-3 bg-green-50/80 backdrop-blur-sm border border-green-200 rounded-lg">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <p className="text-xs text-green-700">
                                      Maximize your impact with recurring donations
                                    </p>
                                  </div>
                                </div>
                                ...
                                <Button className="w-full h-11 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg text-base transition-all duration-300 hover:scale-105 hover:shadow-xl group relative overflow-hidden">
                                  ...
                                  <span className="relative z-10">
                                    Donate{' '}
                                    {formatCurrency(currentStepData.mockData.selected as number)}
                                  </span>
                                  <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform relative z-10" />
                                </Button>
                              </div>
                          ...
                          {currentStep === 2 && (
                            <div className="h-full space-y-4 animate-fade-in">
                              <div className="text-center animate-slide-down">
                                ...
                                <p className="text-sm text-gray-600">
                                  Your donation is protected by enterprise-grade security
                                </p>
                              </div>
                              ...
                              <div className="space-y-3">
                                  ...
                                  <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center space-x-2">
                                      ...
                                      <span className="text-base font-medium text-green-900">
                                        {currentStepData.mockData.method as string}
                                      </span>
                                    </div>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                  {currentStepData.mockData.providers?.map((provider, idx) => (
                                    <div
                                      key={idx}
                                      className="p-2 bg-gray-50/80 backdrop-blur-sm border rounded-lg text-center"
                                    >
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                <div className="p-3 bg-gradient-to-br from-green-50/90 to-emerald-50/90 backdrop-blur-sm border border-green-200 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-green-300">
                                  ...
                                  <div className="text-xl font-bold text-green-900">
                                    {formatCurrency(currentStepData.mockData.totalRaised as number)}
                                  </div>
                                  <div className="text-xs text-green-600">
                                    {currentStepData.mockData.growth as string} this month
                                  </div>
                                </div>
                                ...
                                <div className="p-3 bg-gradient-to-br from-green-50/90 to-emerald-50/90 backdrop-blur-sm border border-green-200 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-green-300">
                                  ...
                                  <div className="text-xl font-bold text-green-900">
                                    {currentStepData.mockData.conversion as string}
                                  </div>
                              ...
                              <div className="space-y-2">
                                <div className="flex items-center justify-between p-2.5 bg-gray-50/80 backdrop-blur-sm rounded-lg transition-all duration-300 hover:scale-105 hover:bg-green-50/80 hover:border hover:border-green-200">
                                  ...
                                  <span className="text-sm font-semibold">
                                    {currentStepData.mockData.campaigns as number}
                                  </span>
                                </div>
                                <div className="flex items-center justify-between p-2.5 bg-gray-50/80 backdrop-blur-sm rounded-lg transition-all duration-300 hover:scale-105 hover:bg-green-50/80 hover:border hover:border-green-200">
                                  <div className="flex items-center space-x-2">
                                  ...
                                  <span className="text-sm font-semibold">
                                    {currentStepData.mockData.kiosks as number}
                                  </span>
                                </div>
                              </div>
                            </div>
                    ...
                    {isPlaying && (
                      <div className="mt-3 sm:mt-4 animate-fade-in flex-shrink-0">
                        ...
                        <Progress
                          value={progress}
                          className="h-1 sm:h-1.5 bg-gray-200 shadow-inner"
                        />
                      </div>
                    )}
                  </div>
                ...
                <div className="xl:col-span-2 flex flex-col min-h-0 h-full">
                  ...
                  <div className="h-full bg-gradient-to-br from-gray-50/50 via-green-50/30 to-emerald-50/50 rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-5 flex flex-col justify-between relative overflow-hidden backdrop-blur-sm border border-gray-200/50">
                    ...
                    <div className="absolute inset-0 opacity-20 pointer-events-none">
                      ...
                      <div
                        className="absolute bottom-10 left-10 w-40 h-40 bg-emerald-300 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
                        style={{ animationDelay: '2s' }}
                      ></div>
                    </div>
                    ...
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                      <div
                        className="absolute top-1/4 right-1/4 w-1 h-1 bg-green-400 rounded-full animate-ping opacity-40"
                        style={{ animationDuration: '4s' }}
                      ></div>
                      <div
                        className="absolute top-2/3 left-1/3 w-1 h-1 bg-emerald-400 rounded-full animate-ping opacity-40"
                        style={{ animationDuration: '5s', animationDelay: '1s' }}
                      ></div>
                      <div
                        className="absolute bottom-1/4 right-1/3 w-1 h-1 bg-green-300 rounded-full animate-ping opacity-40"
                    ...
                    <div className="relative z-10">
                      <div className="p-3 sm:p-4 bg-gradient-to-br from-green-600 to-emerald-600 rounded-xl text-white shadow-lg backdrop-blur-sm relative overflow-hidden group">
                        ...
                        <div className="absolute inset-0 overflow-hidden">
                          <div
                            className="absolute top-1/4 left-1/4 w-1.5 h-1.5 bg-white/30 rounded-full animate-ping"
                            style={{ animationDuration: '3s' }}
                          ></div>
                          <div
                            className="absolute top-3/4 right-1/4 w-1.5 h-1.5 bg-white/30 rounded-full animate-ping"
                            style={{ animationDuration: '4s', animationDelay: '1s' }}
                          ></div>
                        </div>
