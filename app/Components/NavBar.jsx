    ...
    <header className="bg-black py-6 fixed w-full z-999">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="space-x-6">
          ...
          <Link href="/Auth" className="text-white hover:text-blue-300">SignIn</Link>
          <Link href="/UserDashboard" className="text-red-500 hover:text-blue-300">User-Dashboard</Link>
          <Link href="/AdminDashboard" className="text-red-500 hover:text-blue-300">Admin-Dashboard</Link>
