        ...
        <>
            <section className="bg-black py-12" id='features'>
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <img src="/mobile_pay.png"  alt='Flexible Donation Modes' className='w-full pb-4 h-1/2'/>
                    ...
                    <div className="p-6 rounded-md bg-gray-800 hover:bg-gray-700 hover:scale-105 transition-transform duration-300">
                    <img src="/Flex_Donation_mode.png"  alt='Flexible Donation Modes' className='w-full pb-4 h-1/2'/>
                    ...
                    <div className="p-6 rounded-md bg-gray-800 hover:bg-gray-700 hover:scale-105 transition-transform duration-300">
                    <img src="/Camp_setup.png"  alt='Flexible Donation Modes' className='w-full pb-4 h-1/2'/>
                    ...
                    <div className="p-6 rounded-md bg-gray-800 hover:bg-gray-700 hover:scale-105 transition-transform duration-300">
                    <img src="/Real_Time_Funds.png"  alt='Flexible Donation Modes' className='w-full pb-4 h-1/2'/>
                    ...
                    <div className="p-6 rounded-md bg-gray-800 hover:bg-gray-700 hover:scale-105 transition-transform duration-300">
                    <img src="/Integrated_Comm.png"  alt='Flexible Donation Modes' className='w-full pb-4 h-1/2'/>
                    ...
                    <div className="p-6 rounded-md bg-gray-800 hover:bg-gray-700 hover:scale-105 transition-transform duration-300">
                    <img src="/gift_aid.png"  alt='Flexible Donation Modes' className='w-full pb-4 h-1/2'/>
