...
export default function AdminCampaignDashboard() {
  ...
  const percentage = campaign.collectedAmount && campaign.goalAmount
    ? Math.min((campaign.collectedAmount / campaign.goalAmount) * 100, 100).toFixed(0)
    : 0;
          ...
          <div className="col-span-1 row-span-3 p-6 bg-gray-900 rounded-2xl border border-gray-800 shadow-lg flex flex-col justify-between">
           <div>
            ...
            <div className="flex flex-col gap-2 mt-4 mb-4">
              ...
              >
                {actionLoading ? "Processing..." : "Pause Campaign"}
              </button>
              <button
